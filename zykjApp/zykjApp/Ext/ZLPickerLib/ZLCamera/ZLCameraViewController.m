...
- (void)stillImage:(id)sender
{
    ...
    {
        UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"提醒" message:[NSString stringWithFormat:@"最多只能添加%zd张图片",9] delegate:self cancelButtonTitle:nil otherButtonTitles:@"好的", nil];
        [alertView show];
