...
@optional;
- (void)m80AttributedLabelAndClickedOnSelf:(M80AttributedLabel *)label;
- (void)m80AttributedLabelAndLongClickedOnSelf:(M80AttributedLabel *)label;


@end

@protocol M80AttributedLabelDataDelegate <NSObject>

@optional;
- (void)saveM80Links:(NSArray *)links;
- (NSArray *)m80Links;
@end
