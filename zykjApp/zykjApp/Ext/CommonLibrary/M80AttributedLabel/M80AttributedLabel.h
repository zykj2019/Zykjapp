...
@interface M80AttributedLabel : UIControl
...
//关键识别对象
@property (weak, nonatomic) NSObject *keyObj;
//是否可以点击自己
@property (assign, nonatomic) BOOL canClick;

//如果true则表示如果促发有点击事件后面都会存在(解决聊天框里为值变化)
@property (assign, nonatomic) BOOL isCanMove;

//存储urls数组 缓存
@property (weak, nonatomic) id <M80AttributedLabelDataDelegate>dataDelegate;

@property (assign, nonatomic) CGFloat longTapTime;
