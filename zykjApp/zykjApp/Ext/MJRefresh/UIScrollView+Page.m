...
- (void)refreshReset {
    ...
    if ([[self.superview nextResponder] isKindOfClass:[BaseViewController class]]) {
        BaseViewController *baseVC = (BaseViewController *)[self.superview nextResponder];
        [baseVC removeEmptyView];
    }
