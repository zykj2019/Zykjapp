...
@implementation UIControl (UIControl_Block)
...
-(void)UIControlEventTouchUpInside{[self callActionBlockEx:UIControlEventTouchUpInside];}
...
- (void)callActionBlockEx:(UIControlEvents)event {
